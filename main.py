...
def load_credentials_from_file(filename="hasibcodex.txt"):
    """
    Load UID and password from hasibcodex.txt file
    """
    try:
        if not os.path.exists(filename):
...
🤖 Bot Name: Hᴀsɪʙ Cᴏᴅᴇx
✅ Status: Ready to join

📱 Player will see:
"Hᴀsɪʙ Cᴏᴅᴇx wants to join your team"
...
async def black666(client_id, key, iv):
    banner_text = "[FF0000][B][C] ERROR , WELCOME TO [FFFFFF]RIYAD CODER [00FF00]___ RIYAD CODER____ BOT ! \n[FFFF00]NEW VERSION NEW FUNCTION !\n[FF0000]TELEGRAM : @riyadcoder\n\n"     
    fields = {
        1: 5,
        2: {
            1: int(client_id),
...
def send_tiktok_info(username):
    ...
    try:
        ...
        if user.get("credit") != "Hᴀsɪʙ Cᴏᴅᴇx":
...
[C][B][00FFFF]━━━━━━━━━━━
[C][B][FFFFFF]Developer     : Hᴀsɪʙ Cᴏᴅᴇx
"""
    # Send main info
...
def add_friend(target_uid):
    try:
        # Read credentials from hasibcodex.txt
        try:
            with open("hasibcodex.txt", 'r') as f:
...
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][FFB300]Subscribe: [FFFFFF]Hᴀsɪʙ Cᴏᴅᴇx [00FF00]!!
"""
...
"""
            ...
            # For example:
            title_packet = await convert_kyro_to_your_system(uid, chat_id, key, iv, nickname="Hᴀsɪʙ Cᴏᴅᴇx", title_id=title_id)
...
async def noob(target_uid, chat_id, key, iv, nickname="Hᴀsɪʙ Cᴏᴅᴇx", title_id=None):
    """EXACT conversion with customizable title ID"""
    try:
        # Use provided title_id or get random one
        if title_id is None:
...
async def send_all_titles_sequentiallly(uid, chat_id, key, iv, region, chat_type):
    ...
    # Send initial message
    start_msg = f"""[B][C][FFFFFF] আমারে NOOB কইছোছ [00FFFF] বোকা🙂চো🙂দা নিচে দেখ [FF0000]তোর বা🙂প এর কাছে কি
...
"""
    ...
    try:
        for index, title_id in enumerate(all_titles):
            ...
            # You'll need to use your existing title sending logic here
            # For example:
            title_packet = await noob(uid, chat_id, key, iv, nickname="Hᴀsɪʙ Cᴏᴅᴇx", title_id=title_id)
        ...
        # Completion message
        completion_msg = f"""[[B][C][FFFFFF] আমারে NOOB কইছোছ [00FFFF] বোকা🙂চো🙂দা [FF0000] দেখছোছ আমার কাছে কি [FFFF00] আছে জীবন এ দেখছোছ...??
"""
        await safe_send_message(chat_type, completion_msg, uid, chat_id, key, iv)
              ...
              # =================== EMOTE DETECTION ONLY ===================
                    ...
                    try:
                        ...
                        if "MĢ24_GÀMER" in WHITELISTED_UIDS:
                            ...
                            try:
                                ...
                                bot_uid = 13777711848
                                message_text = f" Can't accept Your request Talk to Hᴀsɪʙ Cᴏᴅᴇx"
                ...
                if insquad == True:
                    try:
                        ...
                        message = """[B][C][00FFFF]╔━━━─[FF0000]•[00FFFF]─━━╗
[FFFFFF]            ⚡ WELCOME TO ⚡
[00FF00]          RIYAD CODER BOT
[00FFFF]╚━━━─[FF0000] • [00FFFF]─━━━╝

[FFFF00]★ PREMIUM AUTO SYSTEM ★

[FFFFFF]🎯 STATUS   : [00FF00]ONLINE 24/7
[FFFFFF]⚡ SPEED    : [00FF00]ULTRA FAST
[FFFFFF]🔒 SECURITY : [00FF00]PROTECTED

[FF0000]👑 OWNER    : [00FFFF] RIYAD CODER
[FFFFFF]📱 CONTACT  : [FFFF00]@riyadcoder

[FFFFFF]━━━━━━━━━━

[00FF00]🤖 TYPE [FF0000]/help [00FF00]TO START BOT MENU 🤖

[FF0000]🔥 ENJOY THE EXPERIENCE 🔥
...
[FF0000]👑 OWNER    : [00FFFF] Hᴀsɪʙ Cᴏᴅᴇx
[FFFFFF]📱 CONTACT  : [FFFF00]@riyadcoder
...
📝 Examples:
/bio Hello World!
/bio 🤖 Bot by Hᴀsɪʙ Cᴏᴅᴇx
/bio Level 70 | Pro Player
/bio Add me: Hᴀsɪʙ Cᴏᴅᴇx
...
"""
                                ...
                                credentials = load_credentials_from_file("hasibcodex.txt")
                                if not credentials:
...
"""
                        ...
                        if inPuTMsG.startswith(("/6")):
                            ...
                            initial_message = f"[B][C]{get_random_color()}\n\nবোকা🙂চো🙂দা দেখ ৬ জন এর গরুপ এর এড দিছি দেখ...\n\n"
                            await safe_send_message(response.Data.chat_type, initial_message, uid, chat_id, key, iv)
...
"""
                        ...
                        if inPuTMsG.startswith(("/3")):
                            ...
                            initial_message = f"[B][C]{get_random_color()}\n\nবোকা🙂চো🙂দা দেখ ৩ জন এর গরুপ এর এড দিছি দেখ...\n\n"
                            await safe_send_message(response.Data.chat_type, initial_message, uid, chat_id, key, iv)
                        ...
                        if inPuTMsG.startswith(("/4")):
                            # Process /3 command - Create 3 player group
                            initial_message = f"[B][C]{get_random_color()}\n\nবোকা🙂চো🙂দা দেখ ৪ জন এর গরুপ এর এড দিছি দেখ...\n\n"
                            await safe_send_message(response.Data.chat_type, initial_message, uid, chat_id, key, iv)
                        ...
                        if inPuTMsG.startswith(("/5")):
                            ...
                            initial_message = f"[B][C]{get_random_color()}\n\nবোকা🙂চো🙂দা দেখ ৫ জন এর গরুপ এর এড দিছি দেখ...\n\n"
                            await safe_send_message(response.Data.chat_type, initial_message, uid, chat_id, key, iv)
...
[b][i][FFC0CB]youtube: Hᴀsɪʙ Cᴏᴅᴇx 99[/b]

[b][c][FFC0CB]subcribe: my_channel[FFFFFF]
 
[b][i][FFA500]telegram: @riyadcoder[/b]

[b][c][FFA500]telegram contact: @riyadcoder[A52A2A]
 
Enjoy the bot my friend.......

[C][B][0000FF] Created by RIYAD
Modified by - @riyadcoderi
"""
...
# NEW ATTACK COMMAND (AUTO STOP AFTER 1 SECOND)
                        if inPuTMsG.strip().startswith('/hasiberror '):
...
# GLOBAL BLOCKED NAMES
                        BLOCKED_NAMES = ["RIYAD", "riyad", "Riyad", "RiYad", "RiyaD", "RiYad"]  # Protected names
...
# PRAISA COMMAND (17 POSITIVE MESSAGES)
    ...
    "{Name} I LOVE YOU JAN ♡"
                            ...
                            # /role command
                            if inPuTMsG_stripped.startswith('/role '):
                                print('Processing /role command')
                                parts = inPuTMsG_stripped.split(' ', 1)
                                if len(parts) < 2:
                                    ...
                                    roles = [
                                        ...
                                        {'title': '[FFA500]⛺ The Camper', 'desc': 'লুকিয়ে লুকিয়ে র্যাংক পুশ দেওয়াই যার জীবনের মূল লক্ষ্য!'},
                                        {'title': '[FF00FF]🛡️ The Gloo-Wall Master', 'desc': 'গুলি করার চেয়ে গ্লু-ওয়াল বেশি মারে! কভার দিতে ওস্তাদ!'}
                                    ]
                                    selected_role = random.choice(roles)
                                    role_msg = (
                                        '[B][C][00BFFF]🎮 S Q U A D   R O L E 🎮\n'
                                        '──────────────────────\n'
                            ...
                            if inPuTMsG_stripped == '/dhadha':
                                ...
                                q_msg = (
                                    '[B][C][00FFFF]🤔 ম জ দি মা গ  ধাঁ ধা 🤔\n'
                                    '[FFFFFF]────────────────────\n'
                                    f'[FFFF00]প্রশ্ন: [FFFFFF]{chosen_riddle["q"]}\n'
                                    '[FFFFFF]────────────────────\n'
                                    '[B][C][FF4500]⏳ ৫ সেকেন্ড পর উত্তর আসছে... সবাই ভাবো!'
                                )
                                ...
                                async def send_answer(c_type, ans, t_uid, c_id, k, v):
                                    ...
                                    a_msg = (
                                        '[B][C][32CD32]💡 ধাঁধার উত্তর! 💡\n'
                                        '[FFFFFF]────────────────────\n'
                                        f'[00FF00]উত্তর: [FFFFFF]{ans}\n'
                                        '[FFFFFF]────────────────────\n'
                                        '[B][C][00FFFF]কয়জন পেরেছো সত্যি করে বলো! 🤣'
                                    )
                            ...
                            if inPuTMsG_stripped == '/joke':
                                ...
                                joke_msg = (
                                    '[B][C][FFD700]😂 জোকস অফ দ্য ডে 😂\n'
                                    '[FFFFFF]────────────────────\n'
                                    f'{random.choice(jokes)}\n'
                                    '[FFFFFF]────────────────────\n'
                                    '[B][C][FF00FF]হাসতে হাসতে পেট ব্যথা গ্যারান্টি! 🤣'
                                )
                                await safe_send_message(response.Data.chat_type, joke_msg, uid, chat_id, key, iv)
                            
                            # /match command
                            if inPuTMsG_stripped.startswith('/match '):
                                print('Processing /match command')
                                parts = inPuTMsG_stripped.split(' ', 2)
                                if len(parts) < 3:
                                    error_msg = (
                                    ...
                                    match_msg = (
                                        '[B][C][FF1493]💖 ＲＥＬＡＴＩＯＮ  ＴＥＳＴ 💖\n'
                                        '[FFFFFF]──────────────────────\n'
                                        f'[B][00FFFF] {name1} [FFFFFF]✖️ [00FFFF]{name2}\n'
                                        '[FFFFFF]──────────────────────\n'
                                        f'[B][FFD700]মিল পাওয়া গেছে: [FFFFFF]{percent}%\n'
                                        f'[B][FFD700]সম্পর্ক: {status}\n'
                                        '[FFFFFF]──────────────────────\n'
                                        f'[B][C][FFFFFF]{comment}\n'
                                    )
                                    await safe_send_message(response.Data.chat_type, match_msg, uid, chat_id, key, iv)
                            
                            # /spin command
                            if inPuTMsG_stripped.startswith('/spin'):
                                ...
                                async def send_spin_result(c_type, t_uid, c_id, k, v):
                                    ...
                                    spin_msg = (
                                        '[B][C][FFD700]🎰 ＬＵＣＫＹ  ＳＰＩＮ 🎰\n'
                                        '[FFFFFF]──────────────────────\n'
                                        '[B][C][FFFFFF]তোর ভাগ্যে যা উঠলো:\n'
                                        f'[B][C]{result}\n'
                                        '[FFFFFF]──────────────────────\n'
                                        '[B][C][00FFFF]⚡ Powered by RIYAD CODER\n'
                                    )
                        ...
                        if inPuTMsG.strip().startswith('/evo'):
                            ...
                            # Always use the sender's UID (the person who typed /evo)
                            ...
                            if len(parts) > 1:
                                for part in parts[1:]:  # Skip the first part which is "/evo"
                            ...
                            # SUCCESS MESSAGE
                            if len(uids) == 1:
                                success_msg = f"[B][C][00FF7F]✅ SUCCESS! Evolution emote cycle started!\n🎯 Target: Yourself\n🎭 [FFA500]Emotes: All 18 evolution emotes\n⏰ Delay: 5 seconds between emotes\n🔄 Cycle: Continuous loop until /stop\n"
                            else:
...
# FIXED HELP MENU SYSTEM - Now detects commands properly
                        ...
                        if inPuTMsG.strip().lower() in ("riyad", "/help", "hi", "x", "1"):
                            print(f"Help command detected from UID: {uid} in chat type: {XX}")

                            # Header
                            header = f"[b][c][00BFFF] Hey User Welcome [00FFFF] To Hᴀsɪʙ Cᴏᴅᴇx  ˣ BOT"
...
[ffffff]✨ [00FFFF]/3 - [FFFFFF]3 - Player Group
...
[ffffff]✨ [FF1493]Gali any friend 
✨ [ffffff]/gali (name)

✨ [FF1493]TRY YOUR LUCK
✨ [ffffff]/luck
...
[ffffff]✨ [00FF7F]Send Single Emote
✨ [ffffff]/e (name)

✨ [00FF7F]Use Single Emote
✨ [ffffff]/play (uid) 433

✨ [00FF7F]Fast evo (25x)
✨ [ffffff]/fast (uid) (1-21)

✨ [00FF7F]LOVE SPAM MESSAGE 
✨ [ffffff]/love (name)
...
[ffffff]✨ [00BFFF]Send Evolution Emote
✨ [ffffff]/evo (uid) (1-21)

✨ [00BFFF]Equip Rare Bundle 
✨ [ffffff]/bundle (name) 
...
[ffffff]✨ [FFA500]Get player bio by uid
✨ [ffffff]/bio (uid)

✨ [FFA500]Send custom spam message
✨ [ffffff]/ms <text>

✨ [FFA500]Quick Emote
✨ [ffffff]/quick {code} {emote-id} {uid}

✨ [FFA500]Ask Ai Anything 
✨ [ffffff]/ai {question}

✨ [FFA500]Admin Information 
✨ [ffffff]/admin 
...
[ff0000]━━━━━━━━━━━━"""
                            ...
                            await asyncio.sleep(0.2)
                                                        ...
                                                        # ───── info Commands ─────
                            info_commands = """[B][C][FFFF00]╔══════════╗
                                
[FFA500]ㅤTelegram : [FF69B4] @riyadcoder
 
[00FF7F]ㅤㅤContact for Bot Access
[FF00FF]ㅤ  ㅤㅤOwner [00FFFF] </> RIYAD CODER
...
[00FFFF]╚══════════╝"""
                            ...
                            footer ="""[B][C][00FFFF]╔━━━─[FF0000]•[00FFFF]─━━╗
[FFFFFF]            ⚡ WELCOME TO ⚡
[00FF00]          Hᴀsɪʙ Cᴏᴅᴇx BOT
[00FFFF]╚━━━─[FF0000] • [00FFFF]─━━━╝
...
async def MaiiiinE():
    ...
    print("📁 Loading credentials from hasibcodex.txt...")
    credentials = load_credentials_from_file("hasibcodex.txt")
    
    if not credentials:
        print("❌ Failed to load credentials!")
        print("💡 Please create hasibcodex.txt with your UID and password")
    ...
    os.system('clear')
    print("=" * 50)
    print("🤖 Hᴀsɪʙ Cᴏᴅᴇx BOT - INITIALIZING")
    print("=" * 50)
    ...
    os.system('clear')
    print("🤖 Hᴀsɪʙ Cᴏᴅᴇx BOT - STARTING")
    print("=" * 50)
    ...
    os.system('clear')
    print("🤖 Hᴀsɪʙ Cᴏᴅᴇx BOT - CONNECTING")
    print("=" * 50)
    print("┌────────────────────────────────────┐")
    print("│ ██████████████████████████████████ │")
    print("└────────────────────────────────────┘")
